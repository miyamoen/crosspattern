...
Elm.SewingKit = Elm.SewingKit || {};
Elm.SewingKit.Pattern = Elm.SewingKit.Pattern || {};
Elm.SewingKit.Pattern.Square = Elm.SewingKit.Pattern.Square || {};
Elm.SewingKit.Pattern.Square.make = function (_elm) {
   "use strict";
   _elm.SewingKit = _elm.SewingKit || {};
   _elm.SewingKit.Pattern = _elm.SewingKit.Pattern || {};
   _elm.SewingKit.Pattern.Square = _elm.SewingKit.Pattern.Square || {};
   if (_elm.SewingKit.Pattern.Square.values)
   return _elm.SewingKit.Pattern.Square.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var position = $Basics.fst;
   var x = function (_p0) {    return $Basics.fst(position(_p0));};
   var y = function (_p1) {    return $Basics.snd(position(_p1));};
   var content = $Basics.snd;
   var maybeContent = function (sqr) {
      var _p2 = content(sqr);
      if (_p2.ctor === "Content") {
   ...
   var Modify = function (a) {    return {ctor: "Modify",_0: a};};
   var NoContent = {ctor: "NoContent"};
   ...
   var init = F2(function (x,y) {
      return A2(_op["=>"],A2(_op["=>"],x,y),NoContent);
   });
   var update = F2(function (action,sqr) {
      var _p3 = action;
      switch (_p3.ctor)
      {case "Modify": return A2(_op["=>"],
           position(sqr),
           Content(_p3._0));
         case "Empty": return A2(_op["=>"],position(sqr),NoContent);
         default: return sqr;}
   });
   return _elm.SewingKit.Pattern.Square.values = {_op: _op
                                                 ,init: init
                                                 ,x: x
                                                 ,y: y
                                                 ,position: position
...
Elm.SewingKit = Elm.SewingKit || {};
Elm.SewingKit.Pattern = Elm.SewingKit.Pattern || {};
Elm.SewingKit.Pattern.SquareList = Elm.SewingKit.Pattern.SquareList || {};
Elm.SewingKit.Pattern.SquareList.make = function (_elm) {
   "use strict";
   _elm.SewingKit = _elm.SewingKit || {};
   _elm.SewingKit.Pattern = _elm.SewingKit.Pattern || {};
   _elm.SewingKit.Pattern.SquareList = _elm.SewingKit.Pattern.SquareList || {};
   if (_elm.SewingKit.Pattern.SquareList.values)
   return _elm.SewingKit.Pattern.SquareList.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $SewingKit$Pattern$Square = Elm.SewingKit.Pattern.Square.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var ys = $List.map($SewingKit$Pattern$Square.y);
   var maxY = function (_p0) {    return $List.maximum(ys(_p0));};
   var minY = function (_p1) {    return $List.minimum(ys(_p1));};
   var shrinkOnY = F2(function (dy,sqrs) {
      shrinkOnY: while (true) {
         var _p2 = {ctor: "_Tuple3"
                   ,_0: A2($Basics.compare,dy,0)
                   ,_1: maxY(sqrs)
                   ,_2: minY(sqrs)};
         _v0_2: do {
            switch (_p2._0.ctor)
            {case "GT": if (_p2._1.ctor === "Just") {
                       var _v1 = dy - 1,
                       _v2 = A2($List.filter,
                       function (sqr) {
                          return !_U.eq(_p2._1._0,$SewingKit$Pattern$Square.y(sqr));
                       },
                       sqrs);
                       dy = _v1;
                       sqrs = _v2;
               ...
               case "LT": if (_p2._2.ctor === "Just") {
                       var _v3 = dy + 1,
                       _v4 = A2($List.filter,
                       function (sqr) {
                          return !_U.eq(_p2._2._0,$SewingKit$Pattern$Square.y(sqr));
                       },
                       sqrs);
                       dy = _v3;
                       sqrs = _v4;
   ...
   var xs = $List.map($SewingKit$Pattern$Square.x);
   var maxX = function (_p3) {    return $List.maximum(xs(_p3));};
   var minX = function (_p4) {    return $List.minimum(xs(_p4));};
   var expandOnX = F2(function (dx,sqrs) {
      expandOnX: while (true) {
         var _p5 = {ctor: "_Tuple3"
                   ,_0: A2($Basics.compare,dx,0)
                   ,_1: maxX(sqrs)
                   ,_2: minX(sqrs)};
         _v5_3: do {
            switch (_p5._0.ctor)
            {case "GT": if (_p5._1.ctor === "Just") {
                       var _v6 = dx - 1,
                       _v7 = A2($Basics._op["++"],
                       A2($List.map,
                       $SewingKit$Pattern$Square.init(_p5._1._0 + 1),
                       ys(sqrs)),
                       sqrs);
                       dx = _v6;
                       sqrs = _v7;
               ...
               case "LT": if (_p5._2.ctor === "Just") {
                       var _v8 = dx + 1,
                       _v9 = A2($Basics._op["++"],
                       A2($List.map,
                       $SewingKit$Pattern$Square.init(_p5._2._0 - 1),
                       ys(sqrs)),
                       sqrs);
                       dx = _v8;
                       sqrs = _v9;
         ...
         var _v10 = (dx / $Basics.abs(dx) | 0) * ($Basics.abs(dx) - 1),
         _v11 = _U.list([A2($SewingKit$Pattern$Square.init,0,0)]);
         dx = _v10;
         sqrs = _v11;
         continue expandOnX;
      }
   });
   var shrinkOnX = F2(function (dx,sqrs) {
      shrinkOnX: while (true) {
         var _p6 = {ctor: "_Tuple3"
                   ,_0: A2($Basics.compare,dx,0)
                   ,_1: maxX(sqrs)
                   ,_2: minX(sqrs)};
         _v12_2: do {
            switch (_p6._0.ctor)
            {case "GT": if (_p6._1.ctor === "Just") {
                       var _v13 = dx - 1,
                       _v14 = A2($List.filter,
                       function (sqr) {
                          return !_U.eq(_p6._1._0,$SewingKit$Pattern$Square.x(sqr));
                       },
                       sqrs);
                       dx = _v13;
                       sqrs = _v14;
               ...
               case "LT": if (_p6._2.ctor === "Just") {
                       var _v15 = dx + 1,
                       _v16 = A2($List.filter,
                       function (sqr) {
                          return !_U.eq(_p6._2._0,$SewingKit$Pattern$Square.x(sqr));
                       },
                       sqrs);
                       dx = _v15;
                       sqrs = _v16;
               ...
               default: break _v12_2;}
         } while (false);
         return sqrs;
      }
   });
   var shrink = F3(function (dx,dy,sqrs) {
      return A2(shrinkOnY,dy,A2(shrinkOnX,dx,sqrs));
   });
   var expandOnY = F2(function (dy,sqrs) {
      expandOnY: while (true) {
         var _p7 = {ctor: "_Tuple3"
                   ,_0: A2($Basics.compare,dy,0)
                   ,_1: maxY(sqrs)
                   ,_2: minY(sqrs)};
         _v17_3: do {
            switch (_p7._0.ctor)
            {case "GT": if (_p7._1.ctor === "Just") {
                       var _v18 = dy - 1,
                       _v19 = A2($Basics._op["++"],
                       A2($List.map,
                       A2($Basics.flip,$SewingKit$Pattern$Square.init,_p7._1._0 + 1),
                       xs(sqrs)),
                       sqrs);
                       dy = _v18;
                       sqrs = _v19;
               ...
               case "LT": if (_p7._2.ctor === "Just") {
                       var _v20 = dy + 1,
                       _v21 = A2($Basics._op["++"],
                       A2($List.map,
                       A2($Basics.flip,$SewingKit$Pattern$Square.init,_p7._2._0 - 1),
                       xs(sqrs)),
                       sqrs);
                       dy = _v20;
                       sqrs = _v21;
         ...
         var _v22 = (dy / $Basics.abs(dy) | 0) * ($Basics.abs(dy) - 1),
         _v23 = _U.list([A2($SewingKit$Pattern$Square.init,0,0)]);
         dy = _v22;
         sqrs = _v23;
         continue expandOnY;
      }
   });
   var expand = F3(function (dx,dy,sqrs) {
      return A2(expandOnY,dy,A2(expandOnX,dx,sqrs));
   });
   var positions = $List.map($SewingKit$Pattern$Square.position);
   var update = F2(function (action,sqrs) {
      var _p8 = action;
      switch (_p8.ctor)
      {case "Expand": return A3(expand,_p8._0,_p8._1,sqrs);
         case "Shrink": return A3(shrink,_p8._0,_p8._1,sqrs);
         case "Modify": var updateSquare = function (sqr) {
              return _U.eq($SewingKit$Pattern$Square.position(sqr),
              _p8._0) ? A2($SewingKit$Pattern$Square.update,_p8._1,sqr) : sqr;
           };
           return A2($List.map,updateSquare,sqrs);
         default: return sqrs;}
   });
   var NoOp = {ctor: "NoOp"};
   ...
   var Shrink = F2(function (a,b) {
      return {ctor: "Shrink",_0: a,_1: b};
   });
   var Expand = F2(function (a,b) {
      return {ctor: "Expand",_0: a,_1: b};
   });
   var init = A3(expand,10,10,_U.list([]));
   _op["?"] = $Basics.flip($Maybe.withDefault);
   var width = function (sqrs) {
      return A2(_op["?"],
      A3($Maybe.map2,
      F2(function (max,min) {    return max - min + 1;}),
      maxX(sqrs),
      minX(sqrs)),
      0);
   };
   var height = function (sqrs) {
      return A2(_op["?"],
      A3($Maybe.map2,
      F2(function (max,min) {    return max - min + 1;}),
      maxY(sqrs),
   ...
   return _elm.SewingKit.Pattern.SquareList.values = {_op: _op
                                                     ,init: init
                                                     ,xs: xs
                                                     ,ys: ys
                                                     ,width: width
